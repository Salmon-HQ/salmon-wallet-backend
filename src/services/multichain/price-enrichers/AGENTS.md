...
- Source the upstream quote from the established service for the chain (Solana → `shared/coingecko-service.getTokenPrices`). Do not introduce new HTTP clients here.
