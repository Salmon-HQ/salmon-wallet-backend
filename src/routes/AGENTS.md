...
- Cross-chain / chain-agnostic routers live in `shared/` (`coingecko`, `dapp`, `network`, `info`, plus the `network-route-path` helper). The folder root only holds subfolders.
