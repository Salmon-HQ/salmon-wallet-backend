...
| `ZEROEX_API_URL`, `ZEROEX_API_KEY`, `ZEROEX_MAX_RPS`                                  | 0x Solana Swap API (`/ft/swap/build`); URL defaults to `https://api.0x.org/solana`, RPS to 2 (free tier).                                                                                                                                                                                                                                                                                             |
| `SWAP_FEE_BPS`, `SWAP_FEE_ACCOUNT_OWNER`, `SWAP_PRIORITY_FEE_MICROLAMPORTS`           | Salmon swap fee (output token, owner ATA must exist) and optional priority fee.                                                                                                                                                                                                                                                                                                                       |
