...
Salmon API is the backend that powers the Salmon wallet across mobile, web, and extension. It exposes multi-chain endpoints (Solana, Bitcoin), token / price / NFT services and unsigned Powerup builds.
...
| `HELIUS_TIER`                                                                         | Optional. Set to `paid` to widen Helius rate limits; defaults to free tier (10 req/s burst 20). Read by `src/infrastructure/providers/profiles.js`.                                                                                                                                                                                                                                                   |
