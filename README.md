...
| `JUPITER_PRICE_URL`, `JUPITER_API_KEY`                                                | Jupiter Price v3 + Tokens v2 (token catalog).                                                                                                                                                                                                                                                                                                                                                         |
| `ZEROEX_API_URL`, `ZEROEX_API_KEY`, `ZEROEX_MAX_RPS`                                  | 0x Solana Swap API (`/ft/swap/build`); URL defaults to `https://api.0x.org/solana`, RPS to 5 (free tier).                                                                                                                                                                                                                                                                                             |
